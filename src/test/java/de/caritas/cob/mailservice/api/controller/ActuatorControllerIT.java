...
import de.caritas.cob.mailservice.MailServiceApplication;
import de.caritas.cob.mailservice.api.config.MailTestConfiguration;
...
@SpringJUnitConfig(MailTestConfiguration.class)
class ActuatorControllerIT {
  ...
  @Test
  void getActuatorEndpoints_Should_return403ByCsrfRulesForEndpointsNotExposed() throws Exception {
    mockMvc
